...
"}\n"
"\n"
"#pushButton_load,#pushButton_picker,#pushButton_preview,#pushButton_eraser,#pushButton_reset,#pushButton_add\n"
"{\n"
"background:    white;\n"
"font-weight:bold;\n"
"font-size:15px;\n"
...
"font-family:Arial;\n"
"}\n"
"#pushButton_load:hover,#pushButton_picker:hover,#pushButton_preview:hover,#pushButton_reset:hover,#pushButton_add:hover,#pushButton_eraser:hover{\n"
"background:    orange;\n"
"}\n"
"QLineEdit{\n"
"border-radius:4px;\n"
...
"}")
        ...
        self.gridLayout_2.addWidget(self.horizontalSlider_spacing, 2, 1, 1, 1)
        ...
        self.horizontalSlider_height = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSlider_height.setWhatsThis("")
        self.horizontalSlider_height.setMinimum(100)
        self.horizontalSlider_height.setMaximum(2000)
        self.horizontalSlider_height.setSingleStep(100)
        self.horizontalSlider_height.setProperty("value", 500)
        ...
        self.gridLayout_2.addWidget(self.horizontalSlider_height, 3, 1, 1, 1)
        ...
        self.pushButton_preview.setStyleSheet("icon:url(:/grabber/3596215.png)")
        self.pushButton_preview.setObjectName("pushButton_preview")
        self.horizontalLayout_10.addWidget(self.pushButton_preview)
        ...
        self.horizontalSlider_height.valueChanged['int'].connect(self.label_11.setNum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.horizontalSlider_height.setToolTip(_translate("MainWindow", "Adjust the steps(by pixel) to extract data "))
